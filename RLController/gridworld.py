...
class Gridworld(mdp.MarkovDecisionProcess):
  ...
  def getTransitionStatesAndProbs(self, state, action):
    ...
    if action == 'north' or action == 'south':          # action target pos 0.8(1-noise), 2 action vertical directions 0.2/2; some of these three nextstates maybe not allowed, aggregated to current state
      if action == 'north': 
